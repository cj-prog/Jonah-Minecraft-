# ⛏️ JonahCraft – Minecraft fürs Handy

Ein spielbares Minecraft im Browser – gemacht für Jonah! 🎮

Läuft direkt auf dem Handy (und am PC), ohne Installation und ohne App-Store.
Alles steckt in einer einzigen Datei (`index.html`), komplett ohne fremde Bibliotheken.

## 📱 So spielst du auf dem Handy

Am einfachsten über **GitHub Pages** (kostenlos):

1. In diesem Repository auf **Settings → Pages** gehen
2. Bei **Source**: „Deploy from a branch" wählen
3. Branch auswählen (z. B. `main`, nachdem dieser Branch gemergt wurde) und **Save** drücken
4. Nach 1–2 Minuten ist das Spiel erreichbar unter:
   **`https://cj-prog.github.io/Jonah-Minecraft-/`**
5. Den Link auf dem Handy öffnen – fertig! 🎉

Tipp: Über das ⛶-Symbol im Spiel in den Vollbildmodus wechseln, oder die Seite
über „Zum Startbildschirm hinzufügen" wie eine App installieren.
...
| Aktion | Steuerung |
|---|---|
| Laufen | Daumen auf der **linken** Bildschirmhälfte ziehen (Joystick) |
| Umsehen | Auf der **rechten** Hälfte wischen |
| Block abbauen / setzen | Kurz auf den Block **tippen** |
...
Leertaste springen · Tasten 1–8 Block wählen
...
- Essen! 🥕🍅🍎 Pflanze Karotten- und Tomaten-Beete auf Gras oder Erde und
...
- DIE GROSSE SCHLACHT (v205)! ⚔️👑 Wenn ALLE Missionen geschafft sind,
  ...
  Erst 4 Zombies, dann Schleime dazu, dann die Räuberbande, dann der erste
  RIESE, dann zwei Riesen, dann der Sturmangriff mit 18 Monstern - und ganz
  zum Schluss der MONSTERKÖNIG 👑 persönlich mit seinen Leibwachen. Der
  König hält richtig viel aus, ein Treffer reicht bei weitem nicht!
  Die Schlacht-Monster sind anders als normale: sie versteinern nicht in
  der Sonne, sie verschwinden nie, sie kommen aus jeder Entfernung auf
  Jonah zu - und wer zurückfällt, taucht einfach wieder vor ihm auf.
  Zwischen zwei Wellen gibt es 12 Sekunden Verschnaufpause und 20 €. Oben
  links steht immer, welche Welle dran ist und wie viele Monster noch
  stehen. Wer alle sieben Wellen schafft, bekommt 500 €, 25 Diamanten, ein
  RIESEN-Feuerwerk und einen goldenen Pokal neben sich aufgestellt - und
  heißt für immer SIEGER DER GROSSEN SCHLACHT. Mit dem 🛑-Knopf kann Jonah
  jederzeit abbrechen und später neu anfangen.
...
- Der Roboter parkt in DEINER GARAGE - bei allen anderen Fahrzeugen
  ...
  neun Blöcke hohe Riese überhaupt hineinpasst, ist die Garage in
  deiner Festung zu einer RIESEN-HALLE geworden: über der Garage
  sind die beiden Zwischendecken weg, jetzt geht es dort VIERZEHN
  Blöcke hoch bis unters Dach. Rundherum auf den zwei Etagen
  darüber ist ein Geländer, damit keiner hinunterfällt - von oben
  kannst du deinem Roboter also aufs Blechdach schauen. Das
  Garagentor im Osten ist elf Blöcke hoch und sieben breit
  geworden, damit er hindurchstapfen kann, und mitten in der Halle
  ist sein Stellplatz mit weißem Kreuz und goldenem Rand markiert.
- Der Roboter STAPFT DIR NACH (v185)! 🤖👣 Dein Riesen-Roboter bleibt nicht mehr
  ...
  deiner Festung bist, geht er von allein in die Garage. Dort
  parkt er, bis du wieder losziehst.
...
- Schulen und Kindergärten! 🏫🧸 Jedes Dorf hat jetzt eins von
  ...
  sind auch da. Der Kindergarten ist kunterbunt, mit Trampolin,
  Mal-Tisch, Spielzeugkiste und Sandkasten davor!
